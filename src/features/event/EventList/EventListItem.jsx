...
class EventListItem extends Component {
  render() {
    ...
    let path =
      "https://c5z2h5w9.stackpathcdn.com/wp-content/uploads/2014/08/Male-Fashion-Winter-Jacket-And-Grey-Jeans-Straightening-Tie1.jpg";
        ...
        <Segment>
          <Item.Group>
            <Item>
              ...
              <Item.Image size="tiny" circular src={path} />
