    ...
    render() {
        ...
        if(photos) {
            filteredPhotos = photos.filter(photo => {
                return photo.url !==photo.photoURL
            })
        }
        return (
            <Segment>
                ...
                <Grid>
                    ...
                    <Grid.Column width={4}>
                        ...
                        {this.state.files[0] &&
                        <Cropper style={{height: 200, width: '100%'}} 
                            ref='cropper'
                    ...
                    <Grid.Column width={4}>
                        ...
                        <div>
                          ...
                          <Button.Group>
                              <Button loading={loading} onClick={this.uploadImage} style={{width: '100%'}} positive icon='check'/>
                              <Button disabled={loading} onClick={this.cancelCropt} style={{width: '100%'}} icon='close'/>
                        </Button.Group>                            
                        </div>
                        }
                    </Grid.Column>
